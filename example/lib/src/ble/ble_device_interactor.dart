...
class BleDeviceInteractor {
  BleDeviceInteractor({
    ...
    required Stream<List<int>> Function(QualifiedCharacteristic characteristic)
        subscribeToCharacteristic, required LaikangningSdk laikangningSdk,
        ...
        _laikangningSdk = laikangningSdk,
        _logMessage = logMessage;

  final LaikangningSdk _laikangningSdk;

  LaikangningSdk getLaikangningSdk() => _laikangningSdk;
  ...
  Future<List<int>> readCharacteristic(
    ...
    try {
      ...
      _laikangningSdk.putData(result);
